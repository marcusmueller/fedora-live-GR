...
${BASENAME}.torrent: ${BASENAME}.iso
	mktorrent -o ${BASENAME}.torrent ${BASENAME}.iso -a udp://tracker.openbittorrent.com:80 -a  udp://tracker.opentrackr.org:1337 -a  udp://zer0day.ch:1337 -c "Fedora-Based GNU Radio Live Environment version ${DESC}"
